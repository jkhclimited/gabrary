...
const UmbralsPage: FC = () => {
    ...
    useEffect(() => {
        ...
        if (id === "P24") {
            const cardsList = DB_P24.filter((card: any) => card.element.includes('UMBRA'));;
            setUmbralsState({ ...umbralsState, cards: cardsList, imgSrc: "P24_Images"});
        }
        if (id === "ALC") {
            const cardsList = DB_ALC.filter((card: any) => card.element.includes('UMBRA'));;
            setUmbralsState({ ...umbralsState, cards: cardsList, imgSrc: "ALC_Images"});
        }
        if (id === "SP1") {

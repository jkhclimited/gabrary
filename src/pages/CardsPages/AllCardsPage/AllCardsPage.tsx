        ...
        <div>
            ...
            <div> 
                ...
                <div className="text-row">
                        <p className="cardImgBox"><img className="cardImg" onClick={() => showLightbox('156')} src={process.env.PUBLIC_URL + `/Spoilers_Images/156.jpg`} alt="cotd" /></p>
                        <p style={{ display: (allCardsState.showing ? 'block' : 'none' ) }} className="centerText">Sword Saint of Eventide</p>
                    </div>
                </div>
            </div>
            : <div></div> }
